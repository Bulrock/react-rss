...
export const handlers = [
  ...
  rest.get('https://rickandmortyapi.com/api/character/197', (req, res, ctx) => {
    return res(
      ctx.status(200),
      ctx.json({
        id: 197,
  ...
  rest.get('https://rickandmortyapi.com/api/character/300', (req, res, ctx) => {
    return res(
      ctx.status(200),
      ctx.json({
        id: 300,
  ...
  rest.get('https://rickandmortyapi.com/api/character/000', (req, res, ctx) => {
